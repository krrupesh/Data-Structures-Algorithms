package create.all.binary.trees;
...
public class Main {
	...
	public static ArrayList<Node> constructTrees(int start, int end) {
		...
		/*
		 * iterating through all values from start to end for constructing\ left
