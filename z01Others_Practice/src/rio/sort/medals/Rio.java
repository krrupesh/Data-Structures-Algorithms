...
// Map is ready to be sorted And displayed.
		 System.out.println("Unsort Map......");
	        ...
	        System.out.println("\nSorted Map......By Value");
	        Map<String, Country> sortedMap = sortByValue(unsortedReo);
	        //printMap(sortedMap);
	...
	private static Map<String, Country> sortByValue( Map<String, Country> unsortMap) {
        ...
        Map<String, Country> sortedMap = new LinkedHashMap<String, Country>();
